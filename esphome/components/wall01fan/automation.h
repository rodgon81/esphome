...
template<typename... Ts> class RemoteReceiverAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class OscillationTurnOnAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class OscillationTurnOffAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class OscillationToggleAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class SpeedNoneAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class SpeedLowAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class SpeedMidAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class SpeedHighAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class SpeedToggleAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class ModeNoneAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class ModeNormalAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class ModeNaturalAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class ModeSleepAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class ModeToggleAction : public Action<Ts...> {
 public:
...
template<typename... Ts> class IsPowerOnCondition : public Condition<Ts...> {
 public:
...
template<typename... Ts> class IsTemperatureModeCondition : public Condition<Ts...> {
 public:
