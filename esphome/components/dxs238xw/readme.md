...
![dxs238xw](img_readme/dxs238xw_7w.jpg)
...
- **update_interval** (*Optional*, [Time](https://esphome.io/guides/configuration-types.html)): Delay between data requests, minimum 3s.
...
For the button present on the meter, it must be configured with the following code and call the action `dxs238xw.meter_state_toggle`. [Binary Sensor](https://esphome.io/components/binary_sensor/)
